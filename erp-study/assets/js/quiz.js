/* ============================================================
   ERP Study Hub — quiz engine
   Renders ERP_QUIZ with topic filtering, scoring & review.
   ============================================================ */
(function () {
  "use strict";
  var ALL = window.ERP_QUIZ || [];
  var topics = [];
  ...
  function results() {
    ...
    var best = 0; try { best = parseInt(localStorage.getItem("erp-quiz-best") || "0", 10); } catch (e) {}
    if (pct > best) { try { localStorage.setItem("erp-quiz-best", String(pct)); } catch (e) {} best = pct; }
